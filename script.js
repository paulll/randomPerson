var dicts = {
	...
	// Сначала думал сделать по разным регионам. 
	// Если кому не лень, введите переменные R,x,y для Москвы и всей России. 
	// Пока на Москве и других стоят параметры Питера
	addr: {
		msk: function () {
...
function translit(e) {
	...
	return str.replace(/[А-яёЁ]/g, function(a){return arr[a]||a});
}          
